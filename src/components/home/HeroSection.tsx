      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span className="gradient-text">Designing the Future.</span>
          </motion.h1>
          ...
          >
            We transform visionary ideas into cutting-edge software solutions. From AI-powered 
            applications to enterprise systems, we build the technology that drives tomorrow.
          </motion.p>
